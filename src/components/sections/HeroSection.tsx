    ...
    <section id="hero" className="w-full h-[calc(100vh-3.5rem)] flex items-center justify-center bg-gradient-to-br from-background to-secondary/30 relative overflow-hidden">
      <div className="container mx-auto px-4 md:px-6 text-center">
        <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl lg:text-7xl">
          <span className="block animate-in fade-in slide-in-from-bottom-8 zoom-in-95 spin-in-[-1deg] duration-700 delay-300">Hello, I&apos;m</span>
          <span className="block text-primary mt-2 sm:mt-4 animate-in fade-in slide-in-from-bottom-10 zoom-in-95 spin-in-[1deg] duration-700 delay-500">Chhuon MakaraRoth</span>
        </h1>
