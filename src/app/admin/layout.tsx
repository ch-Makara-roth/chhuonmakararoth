    ...
    <div className="flex min-h-screen">
      <aside className="w-64 bg-card p-4 border-r flex flex-col">
        ...
        <nav className="space-y-1 flex-grow">
          ...
          {/*
          <Link href="/admin/blog" className="flex items-center p-2 rounded-md hover:bg-accent hover:text-accent-foreground transition-colors text-muted-foreground cursor-not-allowed">
            <Newspaper className="mr-3 h-5 w-5" /> Blog (Soon)
          </Link>
          <Link href="/admin/contact" className="flex items-center p-2 rounded-md hover:bg-accent hover:text-accent-foreground transition-colors text-muted-foreground cursor-not-allowed">
            <MessageSquare className="mr-3 h-5 w-5" /> Contacts (Soon)
          </Link>
          */}
        </nav>
